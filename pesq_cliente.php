...
<div class="navbar navbar-inverse navbar">
  ...
  <form class="form-inline" role="form"   method="POST" action="pesq_cliente.php" style="margin-left:10%;">
...
<!-- HTML Form (wrapped in a .bootstrap-iso div) -->
     ...
     <div class="form-group ">
      ...
      <label for="email">Digite o Nome do cliente ou  ID  </label>
...
$sql = mysql_query ("select  * from principal  where protocolo = '$pesq' or empresa like '%$pesq%' " );
...
<?php $pt = $dado ["protocolo"];  ?>
        ...
        <p><strong>NOTA FISCAL: </strong> <?php echo "<a target='_blank' href='pdf/$pdf'> <span class='glyphicon glyphicon-new-window' aria-hidden='true'></a>"?>   </p>
